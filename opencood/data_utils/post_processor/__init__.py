...
from opencood.data_utils.post_processor.ddsh_voxelnext_postprocessor import DdshVoxelNeXtPostprocessor
...
__all__ = {
    ...
    'DdshVoxelNeXtPostprocessor': DdshVoxelNeXtPostprocessor,
}


def build_postprocessor(anchor_cfg, train):
    process_method_name = anchor_cfg['core_method']
    assert process_method_name in __all__, \
        '%s is not found in opencood.data_utils.post_processor.' % \
        process_method_name
